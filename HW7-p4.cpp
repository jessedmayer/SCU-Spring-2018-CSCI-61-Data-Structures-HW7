...
void office_hours_func(double prob, unsigned int total_time, multimap<string,string> &student_topics, map<string, int> &student_frequency, string student_names[]) {
...
int main()
{
    ...
    for (int i=1; i<=runs; i++) {
        office_hours_func(prob, 60, student_topics, student_frequency, student_names);
    }
